                ...
                <footer className="bg-gray-900 text-gray-300 mt-12">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                            ...
                            <div>
                                <div className="mb-6">
                                    <img src="/logo.jpeg" alt="Zahrat Alrabie" className="w-20 h-20 rounded-xl mb-4" />
                                    <h3 className="text-white font-bold text-lg mb-2">Zahrat Alrabie</h3>
                                    <p className="text-primary-400 text-sm font-medium">Fresh Fruits & Vegetables</p>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a href="tel:+971555000000" className="hover:text-white transition-colors">
                                            Customer Support
                                        </a>
                                    </li>
                                    <li>
                                        <a href="mailto:zahratvegfruits@gmail.com" className="hover:text-white transition-colors">
                                            Email Support
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <ul className="space-y-3 text-sm">
                                    <li className="flex items-start gap-2">
                                        ...
                                        <span className="text-gray-400">
                                            Shop 04, Souq Al Jubail,<br />
                                            Al Qasimiah, Sharjah, UAE
                                        </span>
                                    </li>
                                    ...
                                    <li className="flex items-center gap-2">
                                        ...
                                        <a href="mailto:zahratvegfruits@gmail.com" className="hover:text-white transition-colors break-all">
                        ...
                        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                            <p className="text-sm text-gray-500">
                                © {new Date().getFullYear()} Zahrat Alrabie. All rights reserved.
                            </p>
